...
if (numberOfSuccessfullyCreatedProcesses <= 1 && OperatingSystem_IsThereANewProgram() == 0){
{ 
...
if (OperatingSystem_IsThereANewProgram() == 0 && numberOfNotTerminatedUserProcesses == 0){
{ 
